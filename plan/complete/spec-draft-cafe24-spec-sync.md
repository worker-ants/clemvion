...
### 3. `spec/data-flow/integration.md`
...
3. `spec/data-flow/integration.md` — §1.4 (4번째 잡 + connected-expiry 분기 갱신), §2.2 Redis 큐 표, §3.1 stateDiagram, §3.2 status_reason 매핑 표
...
- `spec/data-flow/integration.md` 파일명 규약 위반 (consistency check warning-8) — `spec/data-flow/1-integration.md` 로 git mv. 본 plan 범위 초과로 별도 plan 으로 분리.
