...
- [x] **검증·리뷰**: bootstrap·typecheck·lint·test·build green → `/ai-review`(LOW, Critical 0, WARNING 3) → resolution-applier(W1 user-guide·W2 dismiss·W3 JSDoc + INFO 4, e2e 214 PASS) → `/consistency-check --impl-done`(BLOCK:NO) → PR(base main)
