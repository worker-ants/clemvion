...
본 plan 의 작업 범위 (UI 패턴 카탈로그) 와 무관한 spec 정합 이슈가 함께 발견됐다. 각각 별도 plan 으로 정식 ticket 화 (2026-05-18, 본 PR 내 추가 commit):

- **W-2** → [`spec-data-model-filter-node-type-2026-05-18.md`](../in-progress/spec-data-model-filter-node-type-2026-05-18.md) — `spec/1-data-model.md §2.6` Node.type 에 `filter` 추가 (우선순위 높음, DB enum 영향)
- **W-3** → [`spec-overview-rationale-section-2026-05-18.md`](../in-progress/spec-overview-rationale-section-2026-05-18.md) — `spec/0-overview.md` 말미 `## Rationale` 섹션 신설
- **I-1** → [`spec-overview-cafe24-roadmap-classification-2026-05-18.md`](../in-progress/spec-overview-cafe24-roadmap-classification-2026-05-18.md) — §6.2 Cafe24 분류 정합화
- **I-5** → [`claude-md-naming-convention-root-spec-2026-05-18.md`](../in-progress/claude-md-naming-convention-root-spec-2026-05-18.md) — CLAUDE.md §명명 컨벤션 표에 루트 레벨 항목 추가
