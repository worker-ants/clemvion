...
- [x] `spec/5-system/4-execution-engine.md §4.4` (순환 의존 처리) — **완료** ([[notif-followup-refactor]] PR): §4.4 를 forwardRef/ModuleRef 2종 + 적용 기준 표로 구조화. 현재 "엔진 순환 = `forwardRef`(Nest 권장)" 만
