...
`spec/data-flow/6-knowledge-base.md §2.5` 의 `kb:reembed_started/finished`, `kb:reextract_started/finished` 도 코드상 존재 확인되지 않은 동일 카테고리.
...
- 옵션 A 선택 시 `spec/5-system/6-websocket-protocol.md §4.3` 와 `spec/5-system/8-embedding-pipeline.md §8`, `spec/5-system/10-graph-rag.md §6`, `spec/data-flow/6-knowledge-base.md §2.5` 를 다시 갱신 필요
