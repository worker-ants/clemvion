...
후속 (이번 PR 범위 외, --spec WARNING #1·#2):
- [ ] **`spec/data-flow/3-execution.md` §1.1 시퀀스 다이어그램 + §2.2 BullMQ 표에 `execution-run` 반영** — 현재 old in-process 흐름 기술. mermaid 갱신 필요(별도 project-planner 후속).
