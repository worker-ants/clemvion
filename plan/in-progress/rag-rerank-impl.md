...
- [ ] RerankConfig 엔티티 + 마이그레이션(**V081**) + 모듈/서비스(resolve) + 최소 CRUD
- [ ] KB rerank 컬럼 마이그레이션(**V082**) + KnowledgeBase 엔티티 컬럼 + DTO
...
- [ ] (에이전트) RerankConfig 엔티티/모듈/서비스 + RerankClient/Factory(tei·cohere) + RerankService + V081 + 단위테스트
