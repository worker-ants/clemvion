...
- [x] (impl) `foreach.handler.ts:52` 의 `config` echo 객체에 `errorPolicy: rawConfig.errorPolicy` 추가 — Principle 7 "raw echo 항상" 부합 + spec §5.2 JSON 예시와 일치. 근거: `foreach.handler.ts:51-54` vs `spec/4-nodes/1-logic/9-foreach.md:104`.
