...
0. **(BLOCK 해소)** project-planner 가 spec/1-data-model.md §2.10, spec/2-navigation/4-integration.md §2.2/§2.4/§3.2/§6/§9.2/§9.4/§10/§14.2, spec/data-flow/5-integration.md §3.2 를 갱신. 결과적으로 spec 의 OAuth callback 실패 정책·install_token 식별·pending_install→expired TTL 전이가 명문화된다. → 재 consistency-check.
