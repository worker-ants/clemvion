...
- `backend/src/**/entities/**/*.ts` — TypeORM entity 정의
- `backend/src/migrations/` 또는 `backend/database/migrations/`
- `backend/src/**/repositories/` 또는 service 의 query 호출
- `backend/src/common/db/`
- `spec/1-data-model.md`
- `backend/.env.example` — DB 설정
