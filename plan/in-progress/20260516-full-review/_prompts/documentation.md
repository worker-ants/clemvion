...
- `spec/` 전부 (116 MD)
- `README.md`, `codebase/frontend/AGENTS.md`, `codebase/frontend/CLAUDE.md`, `CLAUDE.md`
- `codebase/backend/src/**` 의 JSDoc / 핵심 함수 주석
- `codebase/frontend/src/**` 의 JSDoc
- `codebase/packages/*/README.md`
- `codebase/frontend/src/content/docs/` — 사용자 docs
