...
- [ ] DOCUMENTATION (동반 갱신 매트릭스 / user-guide)
- [ ] 테스트 선작성 (backend unit: searchWithMeta unsearchable, KbToolProvider envelope; frontend: 카드 경고 렌더)
- [ ] 구현 (A 백엔드 + B 프론트)
- [ ] follow-up plan 신설 (kb-model-change-reembed-followup)
- [ ] TEST WORKFLOW (lint·unit·build·e2e)
- [ ] /ai-review + SUMMARY + Critical/Warning 0
- [ ] `consistency-check --impl-done` BLOCK:NO (spec 연결 코드)
