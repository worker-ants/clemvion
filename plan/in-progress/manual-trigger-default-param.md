...
- [x] /ai-review (CRITICAL 1 + WARNING 11) — fix 진행: (a) 되돌림, ② restoreVersion 예외(W6), W8 retry-turn 교차주석, W11 CHANGELOG, W10 plan. W3/W4/W5(에러코드 spec doc)/W6(잔존 malformed 마이그레이션)는 RESOLUTION.md 에 수용/후속 기록
- [ ] TEST WORKFLOW 재수행 (fix 후)
