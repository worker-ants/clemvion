...
| 순위 | 파일 | 실크기 |
|---|---|---|
| 1 | `spec/1-data-model.md` | 112,225자 |
| 2 | `spec/2-navigation/2-trigger-list.md` | 42,611자 |
| 3 | `spec/2-navigation/3-schedule.md` | 13,035자 |
| 4 | `spec/5-system/2-api-convention.md` | 44,094자 |

기본 예산 `CONSISTENCY_MAX_CONTEXT_SIZE=262144` × `CHECKER_BUDGET_RATIO["corpus"]=0.40`
= **corpus 104,857자**. 1번 파일 하나가 **그 몫보다 크다**(112,225 > 104,857).

결과 — `_prompts/cross_spec.md` 를 파싱해 청크별로 센 값: **적재 1개 / 생략 112개.**
적재된 1개는 `1-data-model.md`(그것도 82,779자로 절단), 생략 112개의 **앞 3개가 2·3·4번** 이다.
즉 이 checker 는 **draft 가 편집하는 세 문서를 한 글자도 못 본 채** 판정하려 했다.
