...
- [x] `/ai-review` **8라운드** — `14_08_45`(C2·W7) → `14_44_08`(C0·W8) → `15_10_25`(C0·W2)
      ...
      2 트래커) → `18_03_01`(C0·W3 — **신규는 1건뿐**, 2건은 트래커 이월이고 SUMMARY 가
      "머지를 막을 사유 아님" 으로 명시). 발견의 성격이 **동작 → 구조 → 문서 자리 →
      ...
      > 그리고 마지막 라운드의 유일한 신규 발견은 **직전 라운드 내 fix 의 부작용**이었다
      > (orphan 을 string 으로 강제 → `[object Object]`). 고치는 편집이 새 결함을 만든다는
      > 사실 자체가 라운드를 더 도는 이유다.
      > **"자매 중 하나만" 이 이 브랜치에서 네 번** 나왔다 — 마커 보존 캐너리 · 양성 단언 ·
      > 노드 레벨 vacuous 단언 · swagger JSDoc 형식. 매번 **내가 한쪽만 고친** 것이다.
      ...
      > 사실이 표 안에서 보이게 했다.
- [x] `--impl-done` **9라운드** 전부 **BLOCK: NO** (`14_44_42` · `15_10_56` · `15_33_05` ·
      `15_59_50` · `16_26_26` · `16_52_12` · `17_14_02` · `17_39_11` · `18_03_37`). `16_26_26`~`17_14_02`
