...
| unicorn | eslint peer | 선언 floor `^9.18` 충족 |
| --- | --- | --- |
| 56.0.0 · 56.0.1 | `>=8.56.0` | ✅ |
| 57.0.0 | `>=9.20.0` | ❌ ← 주석이 지목한 정확히 그 지점 |
| 58 · 59.x | `>=9.22.0` | ❌ |
| 60 · 61.x | `>=9.29.0` | ❌ |
| 62 ~ 65.0.1 | `>=9.38.0` | ❌ |
| 66.0.0 ~ 72.0.0 | `>=10.4` | ❌ (eslint 9 자체를 배제) |

주석의 주장("v57+ 는 >=9.20")이 **정확했다**. 3년 가까이 유효한 근거다.
