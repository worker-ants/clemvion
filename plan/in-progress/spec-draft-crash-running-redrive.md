...
- `spec/data-flow/3-execution.md` §1.x(재시작 resume 서술) — 크래시 fail→re-drive 정합 확인(필요 시 planner 후속). **→ 완료(2026-07-04, `dataflow-exec-seq` PR)**: §1.1 다이어그램 alt 2-way→3-way(RUNNING stalled 재배달 arm = §7.5 case B 재구동) 반영.
