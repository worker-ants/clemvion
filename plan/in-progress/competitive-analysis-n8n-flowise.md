...
**가장 위험한 정합성 갭**: `spec/0-overview.md`가 "분산 워커 풀 수평확장"을 현재형으로 광고하나 §4는 Planned. 이 문구로 비즈니스 로직 실행 플랫폼을 파는 건 위험 → **문구 스코프 정직화 또는 역량 구축** 중 택일, 본 목적이면 **후자**. (v2.1의 "마케팅 표현만 정정" 권고는 철회.)
