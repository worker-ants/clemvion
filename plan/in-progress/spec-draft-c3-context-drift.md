...
- segmentStartMs in-memory 성은 수용된 trade-off(Graceful Shutdown under-count) — 세그먼트-start 영속은 **미확정 후속 candidate**(PR3·PR4 모두 미해소; PR4 는 Q2 defer 로 migration-free 진행, 2026-07-04 확정). 전면 Redis store 미채택.
