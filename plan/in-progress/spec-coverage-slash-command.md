...
- [ ] spec PR + spec-frontmatter-rollout 머지 확인
- [ ] Phase 1: SKILL.md 신설
- [ ] Phase 2: sub-agent 신설
- [ ] Phase 3: orchestrator 작성
- [ ] Phase 4: SKILL.md §Rationale 작성
- [ ] CLAUDE.md §Skill 체계 표에 INFO 행 추가 (선택)
- [ ] 단위 테스트: 알려진 spec 케이스 (텔레그램 케이스 재현 등) 로 sub-agent 동작 검증
- [ ] 산출 위치 (`review/consistency/coverage/<YYYY>/...`) 디렉토리 생성 확인
- [ ] plan `complete/` 이동
