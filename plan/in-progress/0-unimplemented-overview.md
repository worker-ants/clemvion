...
| **Spec 5-system/4-execution-engine §7.5 / §11 Durable Continuation & Graceful Shutdown** | 🚧 Phase 0 (spec) ✅ 2026-05-24 / Phase 1 (hotfix) + Phase 2 (BullMQ continuation-queue + rehydration) 대기 | `workflow-resumable-execution.md` (운영 회귀 대응 — k8s 재배포 시 WAITING_FOR_INPUT 일괄 FAIL 해소) |
