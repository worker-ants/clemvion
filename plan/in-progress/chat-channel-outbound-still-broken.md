...
- [x] 2. dispatcher / fanout silent return 진단 log 추가
- [x] 3. WebsocketService routing context emit 진단 log 추가
- [x] 4. TEST WORKFLOW — lint/unit/build PASS (e2e 진행 중)
- [ ] 5. PR + 사용자에게 재배포·재테스트·log 요청
