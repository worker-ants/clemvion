...
- [x] **검색 지표(순수 TS, LLM비용 0)** — 구현 완료: Recall@k/Precision@k/MRR/nDCG@k/hit-rate, 결정적 tie-break(chunkId 2차 정렬), `--fail-under` CI 게이트. ([`rag-eval-harness.md`](./rag-eval-harness.md))
