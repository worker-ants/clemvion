...
- [ ] **npm scope 확정** — [`eia-sdk-publish.md`](./eia-sdk-publish.md) §사용자 결정 #3 (`@workflow/*` vs `@clemvion/*`). spec 은 "잠정 `@clemvion/web-chat`" 표기. scope 확정 후 spec·코드 동기화.
- [ ] **운영 인프라 확보** — 위젯 CDN 도메인, 불변 버전 호스팅(§spec 10), npm registry.
