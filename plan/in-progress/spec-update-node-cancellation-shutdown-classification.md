...
- [ ] `spec/5-system/6-websocket-protocol.md:375` "replay 중 cancel" 의 **"진행 중 turn 을
      ...
      > **무엇이 낡았나**: 위치를 :375 → :450 으로 정정하거나 'replay 중 cancel' 항목명으로 앵커. 지시 내용(#8 이 §1.1 에 확정한 어휘로 통일)은 그대로 유효.
      > **실측**: "replay turn 진행 중 …진행 중 turn 을 조기 종료하고" 문구는 6-websocket-protocol.md **:450** 에 있다(plan 의 :375 는 stale). 문구는 미정정 — 지적 자체는 유효.
