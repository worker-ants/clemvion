...
export const NODE_DEFINITIONS: NodeDefinition[] = [
  ...
  { type: "loop", category: "logic", label: "Loop", description: "Repeat N times", icon: "Repeat", color: CATEGORY_COLORS.logic, inputs: [{ id: "in", label: "Input", type: "data" }, { id: "emit", label: "Emit", type: "data" }], outputs: [{ id: "body", label: "Body", type: "data" }, { id: "done", label: "Done", type: "data" }], isContainer: true },
