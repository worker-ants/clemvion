...
/*
 * 마커 상수·판별기는 `@/lib/utils/masked-markers` 로 옮겼다 (2026-08-20) — 소비처가 셋이
 * 되면서(폼 프리필 · Re-run 모달 · 에디터 히스토리 로드) 모달·툴바가 이 폼 컴포넌트를
 * import 해야 하는 의존 방향이 생겼기 때문이다. 이 파일은 소비자일 뿐이다.
 */
