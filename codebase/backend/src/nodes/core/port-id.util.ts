 ...
 * direct service call).
 *
 * Frontend has a sibling `codebase/frontend/src/lib/node-definitions/resolve-dynamic-ports.ts`
 ...
 * slug regex 를 통과해야 한다. resolveStablePortId 와 codebase/backend/scripts 가 모두
