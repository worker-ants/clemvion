...
- 위치: `spec/2-navigation/14-execution-history.md` §2.3 vs 구현 `executions/page.tsx`
...
- 위치: `spec/2-navigation/14-execution-history.md` §3.5 vs `[executionId]/page.tsx`
...
- 위치: `spec/2-navigation/14-execution-history.md` §3.6 vs `[executionId]/page.tsx:137-143`
...
- 위치: `spec/2-navigation/14-execution-history.md` §2.1(ASCII art) vs §2.4(테이블 정의)
...
- 위치: `spec/2-navigation/14-execution-history.md` §3.4
...
- 위치: `spec/2-navigation/14-execution-history.md` §3.3
...
- 위치: `spec/2-navigation/14-execution-history.md` §3.6 vs `[executionId]/page.tsx:128`
...
- 위치: `spec/2-navigation/14-execution-history.md` §2.6
