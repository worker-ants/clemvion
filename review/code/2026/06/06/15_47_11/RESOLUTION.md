...
| #4 (W4) | spec | (draft 위임) | `plan/in-progress/spec-update-rag-search.md` — spec §2.2 gradingNoGrounding tool_result 포맷 예시 추가 필요 |
...
| #7 (W7) | spec | (draft 위임) | `plan/in-progress/spec-update-rag-search.md` — spec §4.2 cutoffApplied 의미 확장 명시 + Rationale breaking note |
| #8 (W8) | spec | (draft 위임) | `plan/in-progress/spec-update-rag-search.md` — spec §3.1/§7 pgvector hnsw.ef_search/ivfflat.probes follow-up 추가 |
