...
| #10 | SPEC-DRIFT | (draft 위임) | `plan/in-progress/spec-update-workflow-version-list-response.md` |
...
- spec draft 위임 #10: `plan/in-progress/spec-update-workflow-version-list-response.md` — spec/3-workflow-editor/5-version-history.md §7.1 을 WorkflowVersionListItemDto(snapshot 제외 명시) 구조로 갱신 예정
