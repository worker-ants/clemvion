...
| W#4 | `integrations`, `executions` 스펙에 `page/limit` 및 응답 형식 cross-reference 부재 | `spec/2-navigation/4-integration.md`, `6-execution-history.md` 의 API 표에 §5.2 링크 추가 | spec/2-navigation/* |
