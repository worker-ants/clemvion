...
## 검토 모드
구현 착수 전 검토 (--impl-prep, scope=spec/5-system/8-embedding-pipeline.md)

## Target 문서
경로: `spec/5-system/8-embedding-pipeline.md`

```
### 구현 대상 영역: `spec/5-system/8-embedding-pipeline.md`
(없음)
