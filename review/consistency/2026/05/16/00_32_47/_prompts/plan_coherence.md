...
## 검토 모드
구현 착수 전 검토 (--impl-prep, scope=backend/src/modules/knowledge-base/graph)

## Target 문서
경로: `backend/src/modules/knowledge-base/graph`

```
### 구현 대상 영역: `backend/src/modules/knowledge-base/graph`
(없음)
...
| Callbacks (3종) | `/api/3rd-party/cafe24/callback`, `/api/3rd-party/google/callback`, `/api/3rd-party/github/c
