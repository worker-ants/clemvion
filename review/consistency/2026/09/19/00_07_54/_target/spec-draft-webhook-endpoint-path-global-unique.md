...
- [ ] `--spec` 이 draft — 1차 `review/consistency/2026/09/18/23_39_46` **BLOCK: YES**(Critical 2 · WARNING 1) · 2차 `…/23_54_40` **BLOCK: YES**
  (Critical 2 · WARNING 1) → 아래 «`--spec` 1차 처분» · «2차 처분» 반영 뒤 3차
- [ ] S1~S10 반영
- [ ] `--impl-prep`
- [ ] V131 · V132 · 서비스 · 테스트
- [ ] lint · unit · build · e2e
...
`0-architecture.md:67` · `2-trigger-list.md:194` · `data-flow/10-triggers.md:101 · 243 · 248 · 249` · `data-flow/14-chat-channel.md:175`)는 유일성이 아니라
비밀성 · URL 형식 · 404 · 라우팅 서술이다(`10-triggers.md:248 · 249` 는 S7 절 안의 참인 문장).
