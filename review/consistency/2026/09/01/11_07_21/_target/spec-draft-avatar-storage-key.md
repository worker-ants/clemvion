...
**D-4. frontmatter `pending_plans`** — `spec-update-avatar-upload-implemented.md` 추가
(consistency INFO 2). 나머지 3개 문서에도 동일 등재.
...
### F. `spec/5-system/3-error-handling.md` §1 에러 카탈로그
