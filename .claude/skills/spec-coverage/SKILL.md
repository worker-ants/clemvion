...
- **출력은 markdown**: `review/consistency/coverage/<YYYY>/<MM>/<DD>/<hh>_<mm>_<ss>/SUMMARY.md` 단일 결과 진입점
...
- `review/consistency/coverage/<YYYY>/<MM>/<DD>/<hh>_<mm>_<ss>/SUMMARY.md`
- `review/consistency/coverage/<YYYY>/<MM>/<DD>/<hh>_<mm>_<ss>/_prompt.md` (orchestrator 가 만든 입력)
- `review/consistency/coverage/<YYYY>/<MM>/<DD>/<hh>_<mm>_<ss>/meta.json`
...
### R-3. 산출 위치 = `review/consistency/coverage/` 하위

spec-impl coverage 도 일관성 검토의 한 형태. `review/coverage/` 신규 최상위 경로 신설 회피. CLAUDE.md §정보 저장 위치 표 정합 (PR #287 에서 이미 등재).
