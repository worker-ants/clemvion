...
export class KnowledgeBaseController {
  ...
  // graph 도메인 라우트(re-extract / entities / relations / graph/stats / graph/visualization)는
  // GraphController 로 분리됨 (review/2026-05-02_16-11-51 W15). URL prefix 는 동일하게 유지.
  ...
  async reEmbed(
    ...
    await this.kbService.enqueueEmbedding(docId, { reEmbed: true });
