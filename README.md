...
npx ts-node backend/src/scripts/cleanup-invalid-queue-jobs.ts                              # dry-run
npx ts-node backend/src/scripts/cleanup-invalid-queue-jobs.ts --apply --pause-during-sweep # apply
```
