...
- `backend/src/modules/nodes/nodes.service.ts` — Node CRUD
- `backend/src/modules/edges/edges.service.ts` — Edge CRUD
- `backend/src/modules/workflow-versions/workflow-versions.service.ts` — 버전 스냅샷
- `backend/src/modules/workflow-assistant/` — AI Assistant 세션·메시지·도구 호출
