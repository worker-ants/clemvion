...
| Schedule 삭제 | `removeJob` 으로 BullMQ job 해제 + CASCADE delete trigger | 행 삭제 커밋 **뒤** 그 트리거의 `secret_store` 비밀 정리 ([트리거 목록 §4.3](../2-navigation/2-trigger-list.md#43-cascade-동작)) |
