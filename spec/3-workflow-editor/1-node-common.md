...
| 규칙 | 설명 |
|------|------|
| ID 생성 | 동적 포트 추가 시 slug-regex(`^[a-zA-Z0-9_-]{1,64}$`) 유효 stable id 를 부여한다 (생성 방식은 노드별 — 상세 §1.3) |
