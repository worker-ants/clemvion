...
| 시스템 에러 (`system_error`) | ❌ | `<code>` (예: `LLM_RATE_LIMITED`) + 메시지 첫 1줄 truncate | `[다시 시도]` (retryable=true) 또는 없음 (retryable=false). [Conversation Thread §9.1](../conventions/conversation-thread.md#91-source-별-시각-매핑-강제) |
