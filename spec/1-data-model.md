...
| Integration | (install_token) WHERE install_token IS NOT NULL | Cafe24 Private App URL (`/oauth/install/cafe24/:installToken`) 의 단일 row 식별. NULL 비저장 부분 인덱스로 인덱스 크기 최소화 |
