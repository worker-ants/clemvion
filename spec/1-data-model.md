...
| dimension | Integer? | **embedding 전용** 벡터 차원 (384/512/768/1024/1536/3072). pgvector 컬럼 차원과 결합된 **SoT** — `KnowledgeBase.embedding_dimension` 은 이 값의 파생 캐시. chat/rerank 는 NULL |
