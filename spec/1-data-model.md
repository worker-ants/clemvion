...
- `secret://triggers/{id}/webhook-secret` — Telegram `setWebhook.secret_token` (server-issued)
- `secret://triggers/{id}/slack-signing-secret` — Slack `X-Slack-Signature` HMAC key (provider-issued, [`providers/slack.md §6`](./4-nodes/7-trigger/providers/slack.md#6-보안))
- `secret://triggers/{id}/discord-public-key` — Discord application ed25519 public key ([`providers/discord.md §6`](./4-nodes/7-trigger/providers/discord.md#6-보안))
