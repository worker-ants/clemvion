...
> 관련 문서: [PRD 내비게이션](../../prd/1-navigation.md#31-workflow-list) · [Spec 레이아웃](./0-layout.md) · [Spec 캔버스](../3-workflow-editor/0-canvas.md) · [데이터 모델 - Workflow](../1-data-model.md#24-workflow)
