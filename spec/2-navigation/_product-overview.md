...
├── Web Chat              # 임베드 웹채팅 위젯 설치·미리보기   — 🚧 (계획)
...
| NAV-WC-04 | 외형/콘텐츠 빌더 (BootConfig 필드, 백엔드 미저장 — boot 옵션으로만 emit) | 필수 | 🚧 |
| NAV-WC-05 | 설치 스니펫 생성 + 클립보드 복사. 위젯 cdn-base 미설정 시 비활성+경고 | 필수 | 🚧 |
| NAV-WC-06 | 라이브 미리보기 (M1 hosted iframe, 위젯 호스팅 선행). 조회·복사·미리보기 viewer+ | 권장 | 🚧 |
