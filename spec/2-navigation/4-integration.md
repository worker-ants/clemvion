...
**AI Agent 노출**: `service_type='makeshop'` Integration 은 AI Agent `mcpServers` 셀렉트에서 선택 가능하며, `MakeshopMcpToolProvider` 가 in-process `AgentToolProvider` 로 7 섹션의 161 REST operation 을 MCP tool 로 노출한다 ([MakeShop 노드 §8](../4-nodes/4-integration/5-makeshop.md#8-ai-agent-노출-internal-mcp-bridge)).
