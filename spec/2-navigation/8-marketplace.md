...
> 관련 문서: [PRD 내비게이션](./_product-overview.md#310-marketplace-마켓플레이스) · [PRD 통합/연동](../4-nodes/4-integration/_product-overview.md#4-marketplace-마켓플레이스--미구현-planned) · [Spec 레이아웃](./_layout.md)
