...
[공통 §5](./0-common.md#5-캔버스-요약) — `Cafe24` 행 인용. 요약 포맷: `{resource} · {operation}` (예: `product · product_list`). 연결된 Integration 이 삭제된 경우 `⚠ Missing integration` (앰버색) — **계획 (미구현)**, [공통 §5](./0-common.md#5-캔버스-요약) 의 미구현 항목 참조.
