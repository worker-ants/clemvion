...
> 관련 문서: [PRD 노드 시스템](../../../prd/3-node-system.md#3-logic-노드) · [Spec 노드 개요](../0-overview.md) · [Spec 노드 공통](../../3-workflow-editor/1-node-common.md) · [Spec 표현식 언어](../../5-system/5-expression-language.md) · [Spec 실행 엔진](../../5-system/4-execution-engine.md)
...
- 캔버스에서 [컨테이너](../../3-workflow-editor/0-canvas.md#10-컨테이너-노드)로 렌더링되며, 실행 중 헤더에 현재 진행 인덱스를 표시한다 (예: "Iteration 3/10", "Item 2/5").
...
ForEach 의 결과 배열 인덱스 유지 규칙은 [실행 엔진 §3.2](../../5-system/4-execution-engine.md#32-foreach-실행) 참조.
