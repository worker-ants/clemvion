...
본 ordering 의 단일 SoT 는 본 §11.4. [`spec/conventions/conversation-thread.md §5`](../../conventions/conversation-thread.md#5-ai-agent-자동-주입) 는 thread injection 의 책임을, [Spec AI Agent §6](./1-ai-agent.md#6-실행-로직) 등은 노드별 실행 단계를 다룬다 — ordering 자체는 본 §11.4 만 참조.
