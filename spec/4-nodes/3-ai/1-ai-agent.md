...
| ragTopK | Integer | | `5` | KB tool 호출 시 반환할 청크 수의 기본값 (LLM 이 호출 인자로 override 가능). KB `rerank_mode ≠ off` 면 **리랭크 후** 최종 청크 수로 해석 ([Spec RAG 검색 §3.3](../../5-system/9-rag-search.md#33-검색-후처리--리랭킹-선택적)) |
