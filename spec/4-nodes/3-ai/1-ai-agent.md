...
- v2: multi-thread, token-aware cap, `text_classifier`/`information_extractor` 도 주입, 실행 이력 화면의 cross-node thread view 재구성 (NodeExecution 분산 저장 derived view, N+1 회피 — EH-DETAIL-06).
