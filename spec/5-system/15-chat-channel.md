...
| 400 | `INVALID_BOT_TOKEN` | `newBotToken` 누락/비-string (controller 입력 검증, [`chat-channel.controller.ts:52`](../../codebase/backend/src/modules/chat-channel/chat-channel.controller.ts)) |
...
codebase/backend/src/modules/
  chat-channel/
    ...
    chat-channel-token-rotator.service.ts  # CCH-SE-04-C — 24h grace v2 ref 정리 scheduler
