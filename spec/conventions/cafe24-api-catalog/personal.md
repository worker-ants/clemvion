...
| `wishlists_list` | 위시리스트 조회 | Retrieve a list of products in customer wishlist | GET | `customers/{member_id}/wishlist` | read | ✓ | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-products-in-customer-wishlist) |
