...
| `salesreport_monthly` | 월별 매출 통계 | Retrieve a list of monthly sales | ? | ? | ? |  | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-monthly-sales) |
| `salesreport_hourly` | 시간대별 매출 통계 | Retrieve hourly sales statistics of a store | ? | ? | ? |  | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-hourly-sales-statistics-of-a-store) |
| `salesreport_volume` | 매출 리포트 조회 | Retrieve a sales report | ? | ? | ? |  | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-sales-report) |
