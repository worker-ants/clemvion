...
|----|---|---|---|---|---|---|---|---|
| `shipping_companies_list` | 배송사 목록 조회 | Retrieve a list of shipping carriers | GET | `carriers` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-shipping-carriers) |
