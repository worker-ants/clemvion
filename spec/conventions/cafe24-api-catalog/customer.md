...
| `customergroups_list` | 회원 등급 목록 | Retrieve a list of customer tiers | ? | ? | ? | ✓ | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-customer-tiers) |
| `customergroups_count` | 회원 등급 개수 | Retrieve a count of customer tiers | ? | ? | ? |  | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-count-of-customer-tiers) |
| `customergroups_get` | 회원 등급 단건 조회 | Retrieve a customer tier | ? | ? | ? |  | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-customer-tier) |
| `customergroups_settings_get` | 회원 등급 설정 조회 | Retrieve customer tier settings | ? | ? | ? |  | planned | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-customer-tier-settings) |
