...
| `product_images_delete` | 상품 이미지 삭제 | Delete product images | DELETE | `products/images` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-product-images) |
...
| `product_customproperties_update` | 상품 사용자 정의 속성 수정 | Update user defined properties by product | PUT | `products/{product_no}/customproperties` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-user-defined-properties-by-product) |
| `product_customproperties_delete` | 상품 사용자 정의 속성 삭제 | Delete user defined properties by product | DELETE | `products/{product_no}/customproperties` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-user-defined-properties-by-product) |
...
| `mains_products_list` | 메인 카테고리 상품 목록 | Retrieve a list of products in main category | GET | `mains/{main_code}/products` | read | ✓ | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-products-in-main-category) |
| `mains_products_count` | 메인 카테고리 상품 개수 | Retrieve a count of products in main category | GET | `mains/{main_code}/products/count` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-count-of-products-in-main-category) |
| `mains_products_set` | 메인 카테고리 상품 설정 | Set main category products | POST | `mains/{main_code}/products` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#set-main-category-products) |
| `mains_products_update_sorting` | 메인 카테고리 상품 정렬 수정 | Update fixed sorting of products in main category | PUT | `mains/{main_code}/products/sorting` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-fixed-sorting-of-products-in-main-category) |
| `mains_products_delete` | 메인 카테고리 상품 삭제 | Delete a product in main category | DELETE | `mains/{main_code}/products` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-a-product-in-main-category) |
