...
| `product_variants_get` | 상품 품목 단건 조회 | Retrieve a product variant | GET | `products/{product_no}/variants/{variant_code}` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-product-variant) |
| `product_variants_update` | 상품 품목 수정 | Update a product variant | PUT | `products/{product_no}/variants/{variant_code}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-a-product-variant) |
| `product_variants_update_multiple` | 상품 품목 일괄 수정 | Update multiple product variants | PUT | `products/{product_no}/variants` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-multiple-product-variants) |
| `product_variants_delete` | 상품 품목 삭제 | Delete a product variant | DELETE | `products/{product_no}/variants/{variant_code}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-a-product-variant) |
| `product_variants_inventory_get` | 상품 품목 재고 조회 | Retrieve inventory details of a product variant | GET | `products/{product_no}/variants/{variant_code}/inventories` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-inventory-details-of-a-product-variant) |
...
| `product_options_delete` | 상품 옵션 삭제 | Delete a product option | DELETE | `products/{product_no}/options` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-a-product-option) |
| `product_additionalimages_create` | 추가 이미지 등록 | Create an additional product image | POST | `products/{product_no}/additionalimages` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#create-an-additional-product-image) |
| `product_additionalimages_update` | 추가 이미지 수정 | Update an additional product image | PUT | `products/{product_no}/additionalimages` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-an-additional-product-image) |
| `product_additionalimages_delete` | 추가 이미지 삭제 | Delete an additional product image | DELETE | `products/{product_no}/additionalimages` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-an-additional-product-image) |
| `product_images_upload` | 상품 이미지 업로드 | Upload product images | POST | `products/images` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#upload-product-images) |
| `product_images_delete` | 상품 이미지 삭제 | Delete product images | DELETE | `products/{product_no}/images` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-product-images) |
| `product_approve_get` | 상품 승인 상태 조회 | Retrieve a product approval status | GET | `products/{product_no}/approve` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-product-approval-status) |
| `product_approve_create` | 상품 승인 요청 | Create a product approval request | POST | `products/{product_no}/approve` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#create-a-product-approval-request) |
| `product_approve_update` | 상품 승인 상태 변경 | Update a product approval status | PUT | `products/{product_no}/approve` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-a-product-approval-status) |
| `product_customproperties_get` | 상품 사용자 정의 속성 조회 | Retrieve user defined properties by product | GET | `products/{product_no}/customproperties` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-user-defined-properties-by-product) |
| `product_customproperties_update` | 상품 사용자 정의 속성 수정 | Update user defined properties by product | PUT | `products/{product_no}/customproperties/{property_no}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#update-user-defined-properties-by-product) |
| `product_customproperties_delete` | 상품 사용자 정의 속성 삭제 | Delete user defined properties by product | DELETE | `products/{product_no}/customproperties/{property_no}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-user-defined-properties-by-product) |
| `product_decorationimages_list` | 상품 꾸미기 이미지 목록 | Retrieve a list of product decoration images | GET | `products/{product_no}/decorationimages` | read | ✓ | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-product-decoration-images) |
...
| `product_decorationimages_delete` | 상품 꾸미기 이미지 삭제 | Remove a product decoration image | DELETE | `products/{product_no}/decorationimages/{code}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#remove-a-product-decoration-image) |
...
| `product_hits_count` | 상품 조회수 카운트 | Retrieve a count of product views | GET | `products/{product_no}/hits/count` | read |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-count-of-product-views) |
...
| `product_icons_delete` | 상품 아이콘 삭제 | Remove a product icon | DELETE | `products/{product_no}/icons/{code}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#remove-a-product-icon) |
...
| `product_tags_delete` | 상품 태그 삭제 | Delete a product tag | DELETE | `products/{product_no}/tags/{tag}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-a-product-tag) |
...
| `categories_products_delete` | 카테고리 상품 삭제 | Delete a product by category | DELETE | `categories/{category_no}/products/{product_no}` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#delete-a-product-by-category) |
| `mains_products_list` | 메인 카테고리 상품 목록 | Retrieve a list of products in main category | GET | `mains/{display_group}/products` | read | ✓ | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#retrieve-a-list-of-products-in-main-category) |
