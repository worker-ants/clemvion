...
| `orders_calculation_total` | 주문 결제 금액 계산 | Calculate total due | POST | `orders/calculation` | write |  | supported | [↗](https://developers.cafe24.com/docs/ko/api/admin/#calculate-total-due) |
