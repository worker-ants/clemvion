...
> 관련 문서: [노드 Output 규약](./node-output.md) · [parallel-p2-followups.md 결정 D/E/I](../../plan/complete/parallel-p2-followups.md) · [`graph-warning-rule.ts`](../../codebase/backend/src/nodes/core/graph-warning-rule.ts)
