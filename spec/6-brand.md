...
- `codebase/frontend/public/logo.svg` (옛 덩굴 곡선)
- `codebase/frontend/public/logo-mark.svg` (옛 심볼)
- `codebase/frontend/src/app/icon.svg` (옛 32px favicon)
- `codebase/frontend/src/app/favicon.ico` (옛 단일 사이즈)

정식 자산 9종 — §8.4.1 매트릭스 참조:

- `codebase/frontend/public/logo.svg` *(교체)* — Full logo (light)
- `codebase/frontend/public/logo-dark.svg` *(추가)* — Full logo (dark)
- `codebase/frontend/public/logo-mark.svg` *(교체)* — Icon mark (light, 96px master)
- `codebase/frontend/public/logo-mark-dark.svg` *(추가)* — Icon mark (dark)
- `codebase/frontend/public/logo-wordmark.svg` *(추가)* — Wordmark only
- `codebase/frontend/public/favicon-16.svg` *(추가)* — 16px 전용 vector (§8.4.2)
- `codebase/frontend/src/app/icon.svg` *(교체)* — Next.js metadata icon (32px)
- `codebase/frontend/public/apple-icon.svg` *(임시 추가)* — Apple touch icon. SVG 임시
- `codebase/frontend/public/opengraph-image.svg` *(임시 추가)* — OG image. SVG 임시, metadata 미선언
