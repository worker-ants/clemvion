...
| Favicon multi (16/32/48 합성) | `codebase/frontend/src/app/favicon.ico` | 브라우저 탭. *현재 `.ico` 합성본 미생성 — 실제 자산은 `codebase/frontend/public/favicon-16.svg` (16px 단일), `layout.tsx` metadata 가 이를 참조. 합성 `.ico` 생성은 §8.6 follow-up* |
