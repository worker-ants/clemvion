...
| 워드마크 | system sans-serif (`Helvetica Neue`, `Helvetica`, `Arial`) | weight **500**, letter-spacing `-1px`, font-size **48px** (full logo / wordmark-only 공통). 첫 글자 대문자 `C` + 나머지 소문자 `lemvion` → 표기 *Clemvion*. **단색 단일 fill** — light `#0e1a12` / dark `#e8f5ec`. SVG 자산에 박힘. R-15 참조 |
...
| 변종 | 정식 경로 | 사용처 |
| --- | --- | --- |
| Full logo (light) | `codebase/frontend/public/logo.svg` | 라이트 배경 풀로고 — mark + wordmark (R-15, sub-copy 없음) |
| Full logo (dark) | `codebase/frontend/public/logo-dark.svg` | 다크 배경 풀로고 (R-15, sub-copy 없음) |
| Icon mark (light, 96px master) | `codebase/frontend/public/logo-mark.svg` | 사이드바 collapsed, 로딩, 카드 |
| Icon mark (dark) | `codebase/frontend/public/logo-mark-dark.svg` | 다크 배경 mark |
| Wordmark only | `codebase/frontend/public/logo-wordmark.svg` | 마크 없이 텍스트만 (좁은 자리·이메일 서명 등) |
...
워드마크는 **단색 단일 fill** 만 허용 (R-13 의 단색 규정 + R-15 의 2-tone 폐기 결정).
...
| 자산 경로 | 변경 |
| --- | --- |
| `codebase/frontend/public/logo.svg` | 교체 (R-14 마크 + R-15 워드마크 layout, viewBox `320×80`, sub-copy 없음) |
| `codebase/frontend/public/logo-dark.svg` | 교체 (동일 layout, dark fill) |
...
| `codebase/frontend/public/logo-wordmark.svg` | 교체 (R-15 워드마크, viewBox `220×60`, font 500/48px 단색) |
...
| `codebase/frontend/public/opengraph-image.svg` | 교체 (R-15 embedded 풀로고, sub-copy 없음). metadata 미선언 follow-up 은 8.6.3 그대로 |
